...
// // //   const hideFooterPages = ["/login", "/register", "/booking", "/dashboard", "/cart-checkout", "/styleboard", "/custom-request"];
// // //   const showFooter = !isAdmin && !hideFooterPages.includes(location.pathname);
...
//   const isAdmin = location.pathname.startsWith("/admin");
//   const hideFooterPages = ["/login", "/register", "/booking", "/dashboard", "/cart-checkout", "/styleboard", "/custom-request"];
//   const showFooter = !isAdmin && !hideFooterPages.includes(location.pathname) && !location.pathname.startsWith("/dashboard/bookings/");
